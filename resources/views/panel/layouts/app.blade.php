...
>
    ...
    >
        <div class="py-4 text-gray-500 dark:text-gray-400">
            <a href="/" class="flex items-center ms-4">
                <img src="./images/dinedigital.png" class="h-6 mr-3 sm:h-9" alt="DineDigital Logo" />
                <span class="self-center text-xl font-semibold whitespace-nowrap text-black dark:text-white">dinedigital.</span>
            </a>
            <ul class="mt-6">
            ...
            <ul>
                ...
                <li class="relative px-6 py-3">
                    ...
                    >
                        ...
                        <span class="ml-4">Mulitimedia</span>
                    </a>
                </li>
            </ul>
        </div>
